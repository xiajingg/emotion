...
/**
 * Ollama 性能测试 - 测试不同配置的响应时间
 */
@Slf4j
@SpringBootTest
@ActiveProfiles("prod")
public class OllamaPerformanceTest {
     ...
     */
    @Test
    public void testStressTest_ConcurrentRequests() {
        System.out.println("\n========== 压力测试：连续快速请求（关闭思考模式） ==========");
        ...
        System.out.println("开始执行 " + requestCount + " 次连续请求...\n");
        ...
        for (int i = 0; i < requestCount; i++) {
            ...
            System.out.println("请求 #" + (i + 1) + ": ⏱️  " + elapsed + "ms (" + String.format("%.2f", elapsed / 1000.0) + "秒)");
        }
